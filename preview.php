...
<figure class="bookmark-card">
	<div class="bookmark-container<?php echo $data->thumbnail ? ' has-thumbnail' : ''; ?>">
		<div class="bookmark-content">
			<div class="bookmark-title"><span href="<?php echo $data->source; ?>" data-rel="nofollow noindex ignore" target="_blank"><?php echo $data->title; ?></span><?php echo $data->subtitle ? '&nbsp;&nbsp;<span class="bookmark-subtitle">' . $data->subtitle . '</span>' : ''; ?></div>
